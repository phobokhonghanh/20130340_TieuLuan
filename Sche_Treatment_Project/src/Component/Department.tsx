...
import { CalendarModel, Clinic, ClinicDTO } from "../Models/Model";
...
interface ClinicChooseProps {
  data: ClinicDTO[];
  onClinicSelected: (selectedClinic: ClinicDTO | null) => void;
}
export function ClinicChoose({ data, onClinicSelected }: ClinicChooseProps) {
  const [selected, setSelected] = useState<ClinicDTO | null>();
  ...
  const handleSelectChange = (value: ClinicDTO | null) => {
    setSelected(value);
        ...
        <div className="custom-select-wrapper" ref={dropdownRef}>
          ...
          {showDropdown && (
            <div className="custom-select-dropdown">
              <ul>
                <li onClick={() => handleSelectChange(null)}>
                  <span className="custom-select-placeholder">Tất cả</span>
                </li>
