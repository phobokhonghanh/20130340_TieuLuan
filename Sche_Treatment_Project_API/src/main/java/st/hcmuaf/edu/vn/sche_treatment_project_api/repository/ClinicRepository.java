...
public interface ClinicRepository extends JpaRepository<Clinic, String> {
    ...
    @Query(value = "SELECT EXISTS (SELECT 1 FROM clinic WHERE medical_area_id = :mediaAreaId and clinic_name LIKE :clinicName)", nativeQuery = true)
    Integer existsByClinicName(@Param("mediaAreaId") String mediaAreaId, @Param("clinicName") String clinicName);
